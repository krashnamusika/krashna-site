...
const InMemoriamPopup = ({ onPopupHide }) => {
  return (
    <div className="bg-dark text-white" style={ { minHeight: "100vh", minWidth: "100%", zIndex: 1000, position: "absolute", top: 0, left: 0 } }>
      <div className="container d-flex flex-column align-center h-100" style={{minHeight: "100vh", paddingTop: "2rem", paddingBottom: "2rem"}}>
        <div className="my-auto text-center">
          ...
          <div className="row justify-content-center">
            <div className="col-md-3 col-10">
              <img src={DaanAdmiraalImage} className="img-fluid not-gray"/>
            </div>
          </div>
