...
const TourPage = ({ intl }) => (
  <PageTemplate
    title={intl.formatMessage({ id: 'tour2021.title' })}
    ...
    <div style={{ paddingTop: '60px', flex: 'auto' }}>
      <SectionContainer style={{ backgroundColor: '#065B2B' }}>
        <h1 className="text-center text-white font-weight-bold pb-4 pt-4">
          {intl.formatMessage({ id: 'tour2021.title' })}
        </h1>
      </SectionContainer>
    </div>
    <SectionContainer>
      <div className="lead">
        <Markdown>{intl.formatMessage({ id: 'tour2021.subtitle' })}</Markdown>
      </div>
      <Markdown>{intl.formatMessage({ id: 'tour2021.intro' })}</Markdown>
      <div
      ...
      <Markdown>{intl.formatMessage({ id: 'tour2021.concerts' })}</Markdown>
      <Markdown>{intl.formatMessage({ id: 'tour2021.socialMedia' })}</Markdown>
    </SectionContainer>
  </PageTemplate>
)
