      ...
      <div className="modal-content">
        <div className="modal-header">
          <h5 className="modal-title" id="exampleModalLongTitle">
            {intl.formatMessage({ id: "concert-2021-02-13.donate" })}
          </h5>
          <button
            type="button"
            className="close"
        ...
        <div className="modal-body">
          <p>{intl.formatMessage({ id: "concert-2021-02-13.donate-text" })}</p>
          <p>
        ...
        <div className="modal-footer">
          <button
            ...
            data-dismiss="modal"
          >
            {intl.formatMessage({ id: "concert-2021-02-13.modal-close" })}
          </button>
        </div>
      </div>
    </div>
...
const PosterSection = ({ intl }) => (
  <>
    ...
    <div className="col-sm-12 col-md-8">
      <p>{intl.formatMessage({ id: "concert-2021-02-13.text" })}</p>
    </div>
  </>
);
